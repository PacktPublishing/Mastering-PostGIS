...
folder are mapped to the application's root namespace, 'Ol3Wfs'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Ol3Wfs' in the same way
as `"Ol3Wfs/sass/src"`.
